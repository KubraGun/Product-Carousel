    ...
    const self = {
                ...
                <div id="ebebek-carousel" class="banner">
                    <div class="container">
                        ...
                        <div class="banner__wrapper">
                            ...
                            <div class="carousel-content product-list__best-products"></div>
        ...
        buildCSS: () => {
            const css = `
                ...
                #ebebek-carousel .carousel-btn:hover {
                ...
                #ebebek-carousel .hover-icon,
                #ebebek-carousel .favorite-icon,
                #ebebek-carousel .favorite-hover-icon {
        ...
        fetchAndRenderProducts: () => {
            ...
            $.get(apiURL, (data) => {
                ...
                products.forEach(product => {
                    ...
                    productElement.className = 'carousel-product-item';
